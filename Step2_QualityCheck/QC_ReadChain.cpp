...
void QC_ReadChain()
{
  ...
  TChain* myData =(TChain*) new TChain("KrPb");
  myData->Add("../../Fission2019_Data/MapRoot/MapFission2019_Kr_Pb0089.root");
...
/*
  ...
  hist1->Draw("COLZ");
*/
  KrPbReadTree ReadTree;
  ReadTree.WriteHist(myData, "QC_pdf/a.root");
  ReadTree.SaveCanvas(myData, "QC_pdf/a.pdf");
/*
  char SSD_E[200];
  for(int i=0; i<16; i++)
  {
