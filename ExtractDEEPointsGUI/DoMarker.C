...
//  Cut_analyser->Set_BananaCutFileName("/home/sea/Fission2019_Data/StraighteningData/L1L2_SSD3SSD4_DEECuts.root");
  ...
  Cut_analyser->Set_MarkersFileName("../data/data_PID/new_L2L3_StraighteningGraphData.root", "h2_dE2_ECsI_Tel"); // 选点输出文件路径,与直方图名称前缀
  Cut_analyser->Set_FitParsFileName("../data/data_PID/new_L2L3_StraighteningFitPars.dat");   // PID 带子拟合参数输出路径
  Cut_analyser->Set_BananaCutFileName("../data/New_L2L3BananaCut.root");


//  Cut_analyser->Initial_RootFile("/home/sea/Fission2019_Data/StraighteningData/L1L2_HistData_Run0150-0250.root"); // DEE-plot 输入文件路径
//  Cut_analyser->Set_MarkersFileName("../data/data_PID/new_L1L2_StraighteningGraphData.root", "h2_dE1_dE2_Tel"); // 选点输出文件路径,与直方图名称前缀
//  Cut_analyser->Set_FitParsFileName("../data/data_PID/new_L1L2_StraighteningFitPars.dat");   // PID 带子拟合参数输出路径
//  Cut_analyser->Set_BananaCutFileName("/home/sea/Fission2019_Data/StraighteningData/new_L1L2DEECuts.root");
