////////////////////////////////////////////
// TModV785N.h: Implementation of CAEN
// module V785NAC
...
public:
	TModV785N(){MaxChannel = (unsigned int)fMaxChannel;}  //default constructor, ROOT TClass need this
	...
	ClassDef(TModV785N, 1);
};


#endif //#ifndef V785NAC_H