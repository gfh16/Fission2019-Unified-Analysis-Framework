...
{
  if (TMath::Abs(stripl2b - stripl1s) <= 1) { //
      return true;
  } else {
      return false;
  }
...
{
  if (TMath::Abs(stripl2b - stripl1s) == deltastrip) { //
      return true;
  } else {
      return false;
  }
