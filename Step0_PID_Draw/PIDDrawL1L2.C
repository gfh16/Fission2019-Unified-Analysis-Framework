...
void PIDDrawL1L2()
{
  ...
  std::string pathOut_Cans_PID_L1_L2F(Form("output/SSD_L1CH%02d_L2FCH%02d.png",L1S_CHIndex,L2F_CHIndex));
  std::string pathOut_Cans_PID_L1_L2B(Form("output/SSD_L1CH%02d_L2BCH%02d.png",L1S_CHIndex,L2B_CHIndex));
