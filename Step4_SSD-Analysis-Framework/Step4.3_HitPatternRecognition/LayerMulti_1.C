...
void LayerMulti_1()
{
  ...
  std::string pathMultiDataOut(Form("data/Entries_Multiplicity_Run%03d-Run%03d.dat", FirstRun, LastRun));
  std::string pathLayerMultiPNDOut(Form("figures/Layer_MultiRatio_Run%03d-Run%03d.PNG", FirstRun, LastRun));
  std::string pathSSDMultiPNDOut(Form("figures/SSD_MultiRatio_Run%03d-Run%03d.PNG",   FirstRun, LastRun));

  //ofstream FileOut(pathMultiDataOut.c_str());
  //FileOut<<setw(5)<<"*SSDNum"<<setw(7)<<"CHNum"<<setw(15)<<"Tot_Entries"<<setw(15)<<
...
void Draw_Layer_MultiRatio()
{
  ...
  // TGraph 画图
  // 画出 ratio = 1 作为基准线
  TLine* line_one = new TLine(1, 1.0, 30., 1.0);
  ...
  for (Int_t ssdindex=0; ssdindex<NUM_SSD; ssdindex++)
  {
    ...
    gr_L1SMultiRatio_Clone[ssdindex]->SetMarkerStyle(Maker[0]);
    gr_L2FMultiRatio_Clone[ssdindex]->SetMarkerStyle(Maker[1]);
    gr_L2BMultiRatio_Clone[ssdindex]->SetMarkerStyle(Maker[2]);
    gr_L3AMultiRatio_Clone[ssdindex]->SetMarkerStyle(Maker[3]);

    gr_L1SMultiRatio_Clone[ssdindex]->SetMarkerSize(MakerSize);
    gr_L2FMultiRatio_Clone[ssdindex]->SetMarkerSize(MakerSize);
    gr_L2BMultiRatio_Clone[ssdindex]->SetMarkerSize(MakerSize);
    gr_L3AMultiRatio_Clone[ssdindex]->SetMarkerSize(MakerSize);
  ...
  mg_SSD[0]->GetXaxis()->SetRangeUser(0,30.);
  mg_SSD[0]->GetXaxis()->SetNdivisions(510);
  ...
  mg_SSD[0]->GetYaxis()->SetNdivisions(1010);
  mg_SSD[0]->Draw("APL");
  ...
  mg_SSD[1]->GetXaxis()->SetRangeUser(0,30.);
  mg_SSD[1]->GetXaxis()->SetNdivisions(510);
  ...
  mg_SSD[1]->GetYaxis()->SetNdivisions(1010);
  mg_SSD[1]->Draw("APL");
  ...
  mg_SSD[2]->GetXaxis()->SetRangeUser(0,30.);
  mg_SSD[2]->GetXaxis()->SetNdivisions(510);
  ...
  mg_SSD[2]->GetYaxis()->SetNdivisions(1010);
  mg_SSD[2]->Draw("APL");
  ...
  mg_SSD[3]->GetXaxis()->SetRangeUser(0,30.);
  mg_SSD[3]->GetXaxis()->SetNdivisions(510);
  ...
  mg_SSD[3]->GetYaxis()->SetNdivisions(1010);
  mg_SSD[3]->Draw("APL");
